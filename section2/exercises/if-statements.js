...
// Just wanted to add that all dogs are puppies, no matter how old! :)
...
if (dogAge <= 2) {
  console.log("He is a puppy aka trouble maker");
} else if (dogAge >= 10) {
  console.log("He is elderly aka gets extra treats");
} else if (dogAge >= 3 || dogAge <= 9) {
    console.log ('He is an adult aka a good boy');
} else {
};
...
for yourself!
Yes! Well, I used it for the dog exercise and the pizza exercise
